       ...
       <div class="container">
           ...
           <div class="col-md-6" data-animate="fadeInDown">
               ...
               <?php if(!isset($_SESSION['member'])){  ?> <!-- 判斷帳號不存在 -->
                   ...
                   <li><a href="web/register.php?url=add">加入會員</a>
                   </li>
                <?php }else{ ?>
                <li><a href="customer-account.php" ><?php echo $_SESSION['member']['name_date'];?>您好!</a></li>
                <li><a href="web/logout_success.php">登出</a></li>
                <?php } ?>
           ...
           <div class="modal-dialog modal-sm">
              ...
              <div class="modal-content">
                   ...
                   <div class="modal-body">
                       <form action="web/check_login.php" method="post">
                       ...
                       <p class="text-center text-muted"><a href="web/register.php"><strong>立即註冊</strong></a>! 1分鐘立即註冊即可領取百元購物金 !</p>
       ...
       <div class="container">
           <div class="navbar-header">
               ...
               <div class="navbar-buttons">
                   ...
                   <a class="btn btn-default navbar-toggle" href="web/basket.php">
           ...
           <div class="navbar-buttons">
               ...
               <div class="navbar-collapse collapse right" id="basket-overview">
                   <a href="web/basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i> <span class="hidden-xs">
